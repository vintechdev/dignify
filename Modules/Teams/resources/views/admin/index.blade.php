...
<item-list
    ...
    fields="id,image_id,date,status,name"
    table="teams"
    title="teams"
    include="image"
    appends="thumb"
    ...
    <template slot="add-button">
        @include('core::admin._button-create', ['module' => 'teams'])
    </template>
    ...
    <template slot="columns" slot-scope="{ sortArray }">
        ...
        <item-list-column-header name="title_translated" sortable :sort-array="sortArray" :label="$t('Name')"></item-list-column-header>
    </template>
    ...
    <template slot="table-row" slot-scope="{ model, checkedModels, loading }">
        ...
        <td>@include('core::admin._button-edit', ['module' => 'teams'])</td>
