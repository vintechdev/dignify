...
<head>
    ...
    <!-- Custom CSS 
    <link href="{{ asset('css/vendor.css?=0.12') }}" rel="stylesheet" media="screen">-->
    <link href="{{ asset('css/style.css?=0.20') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/custom.css?=0.27') }}" rel="stylesheet" media="screen">
    <link href="{{ asset('css/responsive.css?=0.20') }}" rel="stylesheet" media="screen">
    @stack('css')
